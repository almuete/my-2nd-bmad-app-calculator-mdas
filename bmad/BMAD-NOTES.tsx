...
Story to apply:
@bmad/stories/FE-005-multiply-equals-style.story.md
Create the file @bmad/prompts/architectures/FE-005-multiply-equals-style.story.architect.md
...
Create the file results @bmad/prompts/reviews/FE-005-multiply-equals-style.review.md
...
Act as PO. Perform acceptance for FE-005 based on:
- Story: @bmad/stories/FE-005-multiply-equals-style.story.md
- Implementation: @app/calculator/page.tsx
- Reviewer results: @bmad/prompts/reviews/FE-005-multiply-equals-style.review.md
- Create the file @bmad/prompts/po-acceptances/FE-005-multiply-equals-style.po.acceptance.md
...
Act as SM. Gate check FE-005 from Reviewer → PO → Done.

Inputs:
- Story: @bmad/stories/FE-005-multiply-equals-style.story.md
- Implementation: @app/calculator/page.tsx
- Reviewer results: @bmad/prompts/reviews/FE-005-multiply-equals-style.review.md
- Create the file results @bmad/prompts/sm-gates/FE-005-multiply-equals-style.sm.gate.md
- PO decision @bmad/prompts/po-acceptances/FE-005-multiply-equals-style.po.acceptance.md
